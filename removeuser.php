...
<body style="background-color : #ff99bb;">
<?php
    include 'config.php';
...
<div class="container">
        <h2 class="text-center pt-4" style="color : white; background-color:#660033;">REMOVE USERS</h2>
        <br>
            <div class="row">
                <div class="col">
         ...
         <footer class="text-center mt-5 py-2" style="background-color:#660033; color:White;" >
